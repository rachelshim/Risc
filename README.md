...
- Unit testing: used to demonstrate the correctness of our State implementation. Tests that state is correctly initialized and updated in a variety of cases. Unit testing was limited in both scope and usefulness do to encapsulation of state, and was mostly used to verify simple updates to state.
